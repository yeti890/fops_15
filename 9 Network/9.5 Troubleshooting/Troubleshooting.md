...
1. Выясняем, проблема касается этих 2-х конкретных устройств или 2-х сегментов сетей. Проверим связь пингом:
    ...
    * Доступность устройств с проблемой PC1-PC4 и PC4-PC1 - !!нет связи!!
    * Доступность соседних устройств PC2-PC3 и PC3-PC2 - !!нет связи!!
    * Доступность устройств внутри сегмента сети PC1-PC2 и PC3-PC4 - !!(green)связь есть!!



1. Проверим доступность других устройств внутри сегмента сети:
    * Сетевая связность внутри сегмента 192.168.1.0/24 присутствует
    * 
